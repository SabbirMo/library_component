    ...
    if (widget.config.svgPath != null && widget.config.svgPath!.isNotEmpty) {
      return SvgPicture.asset(
        ...
        colorFilter: ColorFilter.mode(
          widget.theme?.iconColor ?? Colors.brown,
          BlendMode.dst,
        ),
      ...
      children: [
        Padding(
          ...
          child: Material(
            ...
            child:
                widget.config.isSwitch
                    ? InkWell(
                      onTap: handleTap,
                      borderRadius: _effectiveTheme.borderRadius,
                      highlightColor: Colors.transparent,
                      splashColor:
                          _effectiveTheme.enableRipple
                              ? _effectiveTheme.splashColor
                              : Colors.transparent,
        ...
        Divider(color: Color(0xffDBC9BB), height: 5.0, thickness: 1),
      ],
    );
  }

  Widget _buildAccordionContent(
    AccordionTheme _effectiveTheme,
      ...
      child: Row(
        children: [
          if (widget.config.iconData != null ||
              (widget.config.svgPath != null &&
                  widget.config.svgPath!.isNotEmpty)) ...[
            buildLoadingIcon(
              _effectiveTheme.iconSize,
              _effectiveTheme.iconColor ?? Colors.brown,
            ),
